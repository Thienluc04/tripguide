      ...
      <Comp className="relative w-full">
        <>
          ...
          <input
            type={type}
            className={cn(
              "border-input placeholder:text-muted-foreground focus-visible:ring-ring flex h-9 w-full rounded-md border border-grayEA bg-grayF6 bg-transparent px-3 py-1 text-sm shadow-sm transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:border-primary focus-visible:ring-1 disabled:cursor-not-allowed disabled:opacity-50 dark:shadow-none",
              className,
            )}
            ref={ref}
            id={props.name}
