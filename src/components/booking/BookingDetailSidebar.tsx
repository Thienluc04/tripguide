...
export function BookingDetailSidebar({
  ...
  return (
    <div className="w-[444px] rounded-[20px] border-2 border-grayF3 bg-white px-9 py-10">
      {bookingType === "hotel" && (
        <h2 className="mb-[14px] text-lg font-medium text-black">
      ...
      <div className="mb-6 flex items-center gap-[10px]">
        <YellowStarIcon />
        <p className="text-sm font-medium text-black29">
      ...
      <div className="inline-block">
        <p
          className={cn(
            "mb-4 font-medium leading-6 text-gray8B",
        ...
        <div className="mb-5 h-[1px] w-[170px] bg-grayEE"></div>
      </div>
      <div className="mb-5 flex">
        <div className="flex-1">
          <h3 className="text-sm font-medium text-grayC3">Check in</h3>
          <p className="font-medium leading-6 text-gray8B">June 27, 2020</p>
        </div>
        <div className="h-12 w-[2px] bg-grayF6"></div>
        <div className="ml-[14px] flex-1">
          <h3 className="text-sm font-medium text-grayC3">Check out</h3>
          <p className="font-medium leading-6 text-gray8B">June 30, 2020</p>
        </div>
      </div>
      <div className="mb-10">
        <h3 className="text-sm font-medium text-grayC3">
      ...
      <div className="mb-[30px]">
        <h2 className="mb-10 font-Roboto text-[26px] font-medium leading-7 text-black33">
          {bookingType === "car" ? "Fare summary" : "Booked details"}
        </h2>
        <div className="mb-3 flex flex-col gap-5">
          <div className="flex items-center justify-between">
            <p className="font-medium leading-6 text-gray8B">$119 + 5nights</p>
          ...
          <div className="flex items-center justify-between">
            ...
            <p className="font-medium leading-6 text-black45">-$125</p>
          </div>
          <div className="flex items-center justify-between">
            <p className="font-medium leading-6 text-gray8B">Service free</p>
            <p className="font-medium leading-6 text-black45">$103</p>
          </div>
        </div>
        <div className="flex items-center justify-between rounded-md bg-grayF6 px-3 py-2">
          <p className="font-medium leading-6 text-black2F">Total</p>
          <p className="font-medium leading-6 text-black45">$833</p>
        </div>
      </div>
      <Link
