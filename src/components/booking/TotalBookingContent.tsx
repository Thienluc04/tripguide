...
export function TotalBookingContent(props: TotalBookingContentProps) {
  return (
    <div className="mt-[30px]">
      <div className="mb-[30px] flex items-center justify-between rounded-[20px] bg-white px-7 py-5 shadow-[0px_32px_60px_-20px_rgba(54,_54,_54,_0.06)] dark:bg-black29">
        <div className="flex  gap-4">
          <Image src={totalItemImg} alt="total-item" />
          <div>
            <h3 className="text-2xl font-medium leading-9 dark:text-grayF3">
        ...
        <p className="text-lg font-medium dark:text-grayC3">
          Booked on April 8,2020
        </p>
      </div>
      <div className="flex items-center justify-between rounded-[20px] bg-white px-10 py-7 shadow-[0px_32px_60px_-20px_rgba(54,_54,_54,_0.06)] dark:bg-black29">
        <div className="flex gap-8">
          <div className="flex flex-col items-end gap-3">
            <p className="text-xl font-medium dark:text-grayF3">Booking ID</p>
          ...
          <div className="flex flex-col gap-3">
            <p className="text-xl font-medium dark:text-grayF3">9246940</p>
